...
| Activité | Compétences | Réalisation |
|----------|-------------|-------------|
| A3.2.1 Installation et configuration d’éléments d’infrastructure| C3.2.1.1 Installer et configurer un élément d’interconnexion, un service, un serveur, un équipement terminal utilisateur ( [AIX]({{ site.baseurl }}{% post_url 2019-08-12-AIX_INSTAL %}) - [LINUX]({{ site.baseurl }}{% post_url 2019-08-12-LINUX_INSTAL %})) | <span style="color:green"><strong>100%</strong></span> |
